...
| ⚠️ `GenFit2DCHFitter.cpp` | ====================================================================== |  |  | gaudi:declares_component<br>gaudi:topalg:GenFit2DCHFitterConfig<br>gaudi:topalg:GenFitTracks<br>gaudi:topalg:RetryIfNoFitterInfo<br>gaudi:topalg:outputTracks<br>include:ConstField.h<br>include:Exception.h<br>include:FieldManager.h<br>include:Gaudi/Algorithm.h<br>include:Gaudi/Property.h |
| ⚠️ `GGTF_tracking.cpp` | ====================================================================== |  |  | gaudi:declares_component<br>gaudi:topalg:DCH_v2<br>gaudi:topalg:DchName<br>gaudi:topalg:GGTF_trackingConfig<br>gaudi:topalg:Max3DPerTrack<br>gaudi:topalg:OutputTracksGGTF<br>include:ATen/ATen.h<br>include:DD4hep/Detector.h<br>include:DDSegmentation/BitFieldCoder.h<br>include:Gaudi/Algorithm.h |
